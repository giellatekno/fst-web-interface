...
{:else if state === "done"}
    ...
    <table>
        ...
        <tr><td>Infinitiv</td><td>{show(results, "Inf")}</td></tr>
        <tr><td>PrfPrc</td><td>{show(results, "PrfPrc")}</td></tr>
        <tr><td>PrsPrc</td><td>{show(results, "PrsPrc")}</td></tr>
        <tr><td>Sup</td><td>{show(results, "Sup")}</td></tr>
        <tr><td>VGen</td><td>{show(results, "VGen")}</td></tr>
        <tr><td>VAbess</td><td>{show(results, "VAbess")}</td></tr>
    ...
    <table>
        ...
        <tr><td>Ger</td><td>{show(results, "Ger")}</td></tr>
